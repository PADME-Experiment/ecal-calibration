...
class Run:
    ...
    def configure_adcboard(self,adcboard,channel):
        ...
        # Adjust group/channel masks to use only the required channel
        adcboard.channel_enable_mask = (1 << channel) & 0xffffffff
        adcboard.group_enable_mask = (1 << int(channel/8)) & 0xf
        print "Run - Setting group/channel masks to 0x%01x/0x%08x"%(adcboard.group_enable_mask,adcboard.channel_enable_mask)
